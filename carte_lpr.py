...
frames = []
for y in years:
    path = f"/home/user/idf-foncier/dvf_{COMMUNE_CODE}_{y}.csv"
    try:
...
<div style="position: fixed; top: 10px; left: 50%; transform: translateX(-50%);
  ...
  <b style="font-size:16px;">Transactions immobilières — {COMMUNE_NOM}</b><br>
...
# ── 9. Sauvegarde ────────────────────────────────────────────────────────────
output = "/home/user/idf-foncier/carte_lpr.html"
m.save(output)
