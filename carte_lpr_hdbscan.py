...
heatmap_fg = folium.FeatureGroup(name="Heatmap (intensité prix/m²)", show=False)
HeatMap(
...
poly_fg = folium.FeatureGroup(name="Micro-marchés", show=True)
for cid in sorted(data[data["cluster"] >= 0]["cluster"].unique()):
...
# ── 12. Save ──────────────────────────────────────────────────────────────────
out = "/home/user/idf-foncier/carte_lpr_hdbscan.html"
m.save(out)
