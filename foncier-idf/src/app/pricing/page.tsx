...
const PLANS = [
  {
    ...
    description: "Explorez les micro-marchés IDF en accès libre",
    color: "rgba(255,255,255,0.5)",
    borderColor: "rgba(255,255,255,0.1)",
    features: [
      { text: "Carte interactive IDF + Oise", included: true },
      { text: "Analyse commune de base", included: true },
      { text: "Recherche par commune", included: true },
      { text: "Prix médian + écart département", included: true },
      { text: "Micro-marchés (vue limitée)", included: true },
      { text: "Historique 5 ans", included: false },
      { text: "Comparables détaillés", included: false },
      { text: "Export PDF investisseur", included: false },
      { text: "Alertes nouvelles ventes", included: false },
    ],
  ...
  },
  {
    ...
    price: "29 €",
    period: "/mois",
    description: "Pour les investisseurs et professionnels exigeants",
    color: "#00ff88",
    borderColor: "rgba(0,255,136,0.3)",
    badge: "14 jours gratuits",
    features: [
      { text: "Tout le plan Gratuit", included: true },
      { text: "Historique complet 5 ans", included: true },
      ...
      { text: "Carte multicouche (transports, projets)", included: true },
      { text: "Analyse risques détaillée", included: true },
